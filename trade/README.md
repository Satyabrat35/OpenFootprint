...
There are examples ([Example 1](../impacts/useeio/parquet/Indicator.html) and [Example 2](../impacts/useeio/parquet/SectorvsProductionComplete.html)) of using Apache Parquet files from static html files using DuckDB-Wasm and JavaScript
